...
yield_version: ## bump versions from changeset files (node + bun + deno), commit and tag <pkg>@<semver>
	@claude --print "Generate changeset file content for the changes in @runtimes/node/ folder relative to the changes from the latest litevolve-node:x.x.x tag to the current commit" > $(NODE_CHANGESET_DIR)/curr_changeset.md
	@claude --print "Generate changeset file content for the changes in @runtimes/bun/ folder relative to the changes from the latest litevolve-bun:x.x.x tag to the current commit" > $(BUN_CHANGESET_DIR)/curr_changeset.md
	@claude --print "Generate changeset file content for the changes in @runtimes/deno/ folder relative to the changes from the latest litevolve-deno:x.x.x  tag to the current commit" > $(DENO_CHANGESET_DIR)/curr_changeset.md
